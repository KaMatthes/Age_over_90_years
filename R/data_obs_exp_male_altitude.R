function_obs_exp_male_altitude <- function() {
  ...
  data.obs.exp.altitude.male <- data_age90 %>%
  ...
  save( data.obs.exp.altitude.male ,file=paste0("data/data.obs.exp.altitude.male.RData"))
  write.xlsx(data.obs.exp.altitude.male ,file=paste0("data/data.obs.exp.altitude.male.xlsx"),rowNames=FALSE, overwrite = TRUE)
